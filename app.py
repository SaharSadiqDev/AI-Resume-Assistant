...
def analyze_resume(resume_text: str, job_description: str = "") -> dict:
    ...
    job_context = job_description.strip() or (
        ...
        "Evaluate the resume using general ATS best practices."
    )
...
- Identify likely ATS parsing problems such as tables, columns, graphics,
  icons, unusual headings, headers/footers, or overly complex formatting only
  when there is evidence in the extracted text or the user explicitly describes them.
...
def show_results(result: dict) -> None:
    ...
    with col2:
        ...
        st.caption(
            "This is an AI estimate, not a score from a specific "
            "employer's ATS."
        )
...
st.write(
    ...
    "keyword feedback, and practical improvements "
...
with st.sidebar:
    ...
    st.info(
        "Tip: Add the target job description for "
        "more useful keyword matching."
    )
...
st.caption(
    "Privacy note: the extracted resume text is sent to "
    "Gemini for analysis. Do not upload highly sensitive "
    "information unless you are comfortable sharing it "
